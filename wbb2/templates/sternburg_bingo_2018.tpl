...
<head>
	<title>$master_board_name | Sternburg Bingo 2018</title>
	$headinclude
	<style>
	.field {
					...
					<tr class="tablea_fc">
						<td align="left">
							<span class="smallfont">
								<b>
									<a href="index.php{$SID_ARG_1ST}">$master_board_name</a> &raquo; Sternburg Bingo 2018 v1
								</b>
							</span>
						</td>
			...
			<td align="left">
				<table cellpadding="4" cellspacing="1" border="0" style="width:100%" class="tableinborder">
					...
					<tr align="left">
						<td colspan="2" class="tablea" align="center">
							<span class="smallfont">
								<form action="./sternburg_bingo_2018.php" method="post">
